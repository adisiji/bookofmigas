package nb.scode.bukumigas.app;
...
import nb.scode.bukumigas.util.LruBitmapCache;
...
public class App extends Application implements Constants {
	...
	public void onCreate() {
		...
		Fabric.with(this, new Crashlytics());   mInstance = this;
...
//                    hidepDialog();
        ...
        int socketTimeout = 10;//0 seconds - change to what you want
